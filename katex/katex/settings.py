"""
Django settings for katex project.
...
SECRET_KEY = 'django-insecure-f3lf+liwyo_ip9atqi9e1^hev(y5x&91m=rm)b73@on#+#=*&&'
...
WSGI_APPLICATION = 'katex.wsgi.application'
...
AUTH_USER_MODEL = 'katexpower.UserProfile'
